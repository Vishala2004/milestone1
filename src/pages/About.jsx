            ...
            <div className="container sectionabout p-2 " >
              <ol className="ccardds__container" title="Blog entries">
                <li className="ccardd">
                  ...
                  <div className="ccardd__thumb">
                    <Slide direction='left'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWL5v_i5W-1tLs-yVUENtvnBiQtfbT_KncHA&s" alt='anugul' />
                    </Slide></div>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeLGeY2ydJ8jH-i32B6AzFH4DvTh763ATzGQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='left'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSppDZFBQ8vI0tt-_A69QL68-96Nr6Tsz7FJw&s" alt='about'/></Slide></div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgdNRHaYAYws5acikHk5ZdjqYOfVQhQkI8eA&s" alt='about'/></Slide></div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='left'>
                      <img style={{ height: '370px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUW9vwZwoc3p9AemBAVkI0xaj8H5iaU-q94w&s" alt='about'/></Slide></div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src="https://upload.wikimedia.org/wikipedia/commons/1/1c/Ramnath_Temple_-_Boudh%2C_Orissa%2C_India.jpg" alt='about'/></Slide></div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='left'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-wcUC6ut9oN8D8gld_JkD_1dObWfXK9CaEw&s" alt='about'/></Slide></div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9gimuMZ5U32ZUnascVnAVdWFo3M56T248Rw&s" alt='about'/></Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='left'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAIjNnlUIwh9cdEbftapSBBYqxHxH_2cZxYQ&s" alt='about'/></Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDo890dsxpB5UCLQFdVBWmK4qVxTrsrLEEUg&s" alt='about'/></Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYD-MHnGbH0pxaJedeGdhgrfb9X1RAAr-RzQ&s" alt='about' />
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '440px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkBh21mUM40qS_MktFPlNq97fym_YYI2gpYQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKx8cweGtTJx5ts0mDwC31t49JebjFG80AIA&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuWRFwbN_Pg8O6eLJOgDWKuZniTDz2X94nPg&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAgWry-8GfvFdVkxpx3g9NAJqv9-jWQG-lSA&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '400px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1NmqGm_aNdoGkVPRufAx8aXySSY6KhEkwng&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBrY0gZd28BPAifKm0_D95rFbjdeFTQGTaCQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrHJqhrNJjE_EJOOttlI6HLVbqRLluVbysNQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQxoCQKDJ-3aMQoKCQ2oRCu8pGe4LGUBnddQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2teys4lCPDKLbgX47kc8DRpd2f1cRArg4TQ&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgSEI5brAmFadZQOuUMqbw3hFrHoWijqjv4A&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrMS3zWrAQ5sL7FJsQbN5g4lzmcuXZBTcWSw&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEkpAwm5nPgy4XlCazyFfbQvmsdhhr7Koi8A&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnoNEMv2XSu2Ku_XErXdujYs75fZF_rmGrng&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0b/f3/0e/ec/waterfall-next-to-cave.jpg?w=1400&h=1400&s=1" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTS9uuL4BIQXn6w-0-0qp4xeIWbSB-cUknYqg&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdL0B8DNegRMkDTlP2or2y9PEcXxnSl425qw&s" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
                ...
                <li className="ccardd">
                  <div className="ccardd__thumb">
                    <Slide direction='right'>
                      <img style={{ height: '500px' }} className="animate" src="https://www.hlimg.com/images/places2see/738X538/48_1537772601m.jpg" alt='about'/>
                    </Slide>
                  </div>
                  <div className="ccardd__content">
                    <Slide direction='down'>
